...
public class CircleRefreshImageView extends ImageView {
    ...
    public CircleRefreshImageView(Context context, int color) {
        super(context);
    ...
    private class OvalShadow extends OvalShape {
        ...
        public void draw(Canvas canvas, Paint paint) {
            final int viewWidth = CircleRefreshImageView.this.getWidth();
            final int viewHeight = CircleRefreshImageView.this.getHeight();
