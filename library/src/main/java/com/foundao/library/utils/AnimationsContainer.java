...
public class AnimationsContainer {
     ...
     * 创建动画
     */
    public FramesSequenceAnimation createAnim(ImageView imageView, @ArrayRes int resId, int fps) {
    ...
    private int[] getData(int resId) {
        TypedArray array = BaseApp.getAppContext().getResources().obtainTypedArray(resId);
